 ...
 * build.gradle reads MOD_VERSION from this file for the output jar name.
 */
public final class ModInfo {
    ...
    public static final String MOD_VERSION     = "v0.2beta";
    public static final String MOD_DESCRIPTION = "Added some features to the Masa collection of mods.";
    public static final String MOD_AUTHORS     = "plusls, Hendrix-Shen, chara201x, claude4.6-opus";
